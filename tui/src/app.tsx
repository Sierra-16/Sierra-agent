...
import { filterCommandHints } from "./commands.js";
  ...
  const hints = useMemo(
    () =>
      ...
      !app.composer.state.input.includes(" ")
        ? filterCommandHints(app.composer.state.input, app.commands)
        : [],
    [app.commands, app.composer.state.input, app.pendingUserInput]
  );
