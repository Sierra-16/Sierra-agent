...
| `edgeResistance` | 0�?; resistance when dragging past bounds |
...
// or explicit segment: from 0�? to 0�?00%
...
| `alignOrigin` | `[x, y]` origin (0�?); default `[0.5, 0.5]` |
| `autoRotate` | Rotate element to follow path tangent |
| `curviness` | 0�?; path smoothing |
